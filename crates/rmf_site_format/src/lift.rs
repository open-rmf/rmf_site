...
use bevy::{
    math::Vec3A,
    prelude::{
        Bundle, Component, Deref, DerefMut, Query, Reflect, ReflectComponent, With, Without,
    },
...
pub struct Lift {
    ...
    pub cabin_anchors: BTreeMap<Entity, Anchor>,
}
...
impl LiftCabinDoor {
    pub fn convert(&self, id_map: &HashMap<Entity, Entity>) -> Result<LiftCabinDoor, Entity> {
        Ok(LiftCabinDoor {
...
impl LevelVisits {
    pub fn convert(&self, id_map: &HashMap<Entity, Entity>) -> Result<LevelVisits, Entity> {
        let set: Result<BTreeSet<Entity>, Entity> = self
            .0
            .iter()
...
impl LiftCabin {
    ...
    pub fn level_door_anchors(&self, door: Entity) -> Option<[Anchor; 2]> {
        match self {
            Self::Rect(params) => {
    ...
    pub fn convert(&self, id_map: &HashMap<Entity, Entity>) -> Result<LiftCabin, Entity> {
...
impl RectangularLiftCabin {
    ...
    ) -> Result<RectangularLiftCabin, Entity> {
...
impl LiftProperties {
    pub fn convert(&self, id_map: &HashMap<Entity, Entity>) -> Result<LiftProperties, Entity> {
        Ok(LiftProperties {
...
impl LiftCabinDoorPlacement {
    pub fn convert(
        &self,
        id_map: &HashMap<Entity, Entity>,
    ) -> Result<LiftCabinDoorPlacement, Entity> {
...
impl LiftCabinDoorPlacement {
    pub fn new(door: Entity, width: f32) -> Self {
