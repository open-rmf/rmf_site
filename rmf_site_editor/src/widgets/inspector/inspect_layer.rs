    ...
    pub fn show_widget(
        ...
        if with_moving {
            if self.drawings.contains(id) {
                ui.horizontal(|ui| {
                    MoveLayer::<DrawingMarker>::new(id, &mut self.drawing_change_rank, &self.icons)
                        .show(ui);
                });
            }
            ...
            if self.floors.contains(id) {
                ui.horizontal(|ui| {
                    MoveLayer::<FloorMarker>::new(id, &mut self.floor_change_rank, &self.icons)
                        .show(ui);
                });
            }
        }
