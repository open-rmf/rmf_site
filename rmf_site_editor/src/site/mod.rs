...
impl Plugin for SitePlugin {
    fn build(&self, app: &mut App) {
        app.add_state(SiteState::Off)
            ...
            .add_system_to_stage(CoreStage::PostUpdate, buffer_to_selection::<POINT_PICKING_LAYER>)
            .add_system_to_stage(CoreStage::PostUpdate, buffer_to_selection::<LINE_PICKING_LAYER>)
